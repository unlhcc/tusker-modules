...
load("udunits/2.1","szip/2.1","netcdf/4.1","hdf5/1.8.6","hdf4/4.2")

prepend_path("PATH","/util/opt/NCL/6.0/pgi/11.10/64/bin")
prepend_path("MANPATH","/util/opt/NCL/6.0/pgi/11.10/64/man")

setenv("NCARG_ROOT","/util/opt/NCL/6.0/pgi/11.10/64")
setenv("NCARG_INC","/util/opt/NCL/6.0/pgi/11.10/64/include")
setenv("NCARG_LIB","/util/opt/NCL/6.0/pgi/11.10/64/lib")
setenv("NCARG_BIN","/util/opt/NCL/6.0/pgi/11.10/64/bin")
