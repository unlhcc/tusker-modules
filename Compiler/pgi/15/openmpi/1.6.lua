...
prepend_path("PATH",                "/util/opt/openmpi/1.6/pgi/15/bin")
prepend_path("LD_LIBRARY_PATH",     "/util/opt/openmpi/1.6/pgi/15/lib")
...
prepend_path("LIBRARY_PATH",     "/util/opt/openmpi/1.6/pgi/15/lib")
prepend_path("CPATH",             "/util/opt/openmpi/1.6/pgi/15/include")
prepend_path("PKG_CONFIG_PATH",        "/util/opt/openmpi/1.6/pgi/15/lib/pkgconfig")
