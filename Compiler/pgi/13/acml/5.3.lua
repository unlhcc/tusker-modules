...
prepend_path("LD_LIBRARY_PATH",     "/util/opt/acml/5.3/pgi64_fma4/lib")
setenv("CFLAGS",     "-I/util/opt/acml/5.3/pgi64_fma4/include")
setenv("FFLAGS",     "-I/util/opt/acml/5.3/pgi64_fma4/include")
