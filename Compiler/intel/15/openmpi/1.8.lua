...
local mdir = pathJoin(mroot,"MPI","intel","15","openmpi","1.8")
prepend_path("MODULEPATH",          mdir)

family("mpi")

prepend_path("LIBRARY_PATH",     "/util/opt/openmpi/1.8/intel/15/lib")
prepend_path("CPATH",             "/util/opt/openmpi/1.8/intel/15/include")
prepend_path("PKG_CONFIG_PATH",        "/util/opt/openmpi/1.8/intel/15/lib/pkgconfig")