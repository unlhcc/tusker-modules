...
prepend_path("PATH",		    "/util/opt/udunits/2.1/intel/11/bin")
prepend_path("LD_LIBRARY_PATH",     "/util/opt/udunits/2.1/intel/11/lib")
prepend_path("MANPATH",             "/util/opt/udunits/2.1/intel/11/share")
prepend_path("INCLUDE",             "/util/opt/udunits/2.1/intel/11/include")

family("udunits2")

prepend_path("LIBRARY_PATH",     "/util/opt/udunits/2.1/intel/11/lib")
prepend_path("CPATH",             "/util/opt/udunits/2.1/intel/11/include")