...
prepend_path("PATH",                "/util/opt/hdf5/1.8/intel/11/bin")
...
prepend_path("LIBRARY_PATH",     "/util/opt/hdf5/1.8/intel/11/lib")
prepend_path("CPATH",             "/util/opt/hdf5/1.8/intel/11/include")
