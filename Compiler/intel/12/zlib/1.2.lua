...
prepend_path("LIBRARY_PATH",     "/util/opt/zlib/1.2/intel/12/lib")
prepend_path("CPATH",             "/util/opt/zlib/1.2/intel/12/include")
prepend_path("PKG_CONFIG_PATH",        "/util/opt/zlib/1.2/intel/12/lib/pkgconfig")