...
local mdir = pathJoin(mroot,"MPI","intel","12","openmpi","1.6")
prepend_path("MODULEPATH",          mdir)

family("mpi")

prepend_path("LIBRARY_PATH",     "/util/opt/openmpi/1.6/intel/12/lib")
prepend_path("CPATH",             "/util/opt/openmpi/1.6/intel/12/include")
prepend_path("PKG_CONFIG_PATH",        "/util/opt/openmpi/1.6/intel/12/lib/pkgconfig")