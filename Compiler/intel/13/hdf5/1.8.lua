...
prepend_path("PATH",                "/util/opt/hdf5/1.8/intel/13/bin")
prepend_path("LD_LIBRARY_PATH",     "/util/opt/hdf5/1.8/intel/13/lib")
prepend_path("MANPATH",             "/util/opt/hdf5/1.8/intel/13/share/man")
prepend_path("INCLUDE",             "/util/opt/hdf5/1.8/intel/13/include")

family("hdf5")

prepend_path("LIBRARY_PATH",     "/util/opt/hdf5/1.8/intel/13/lib")
