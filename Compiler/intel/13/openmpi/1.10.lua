...
local mdir = pathJoin(mroot,"MPI","intel","13","openmpi","1.10")
prepend_path("MODULEPATH",          mdir)

family("mpi")

prepend_path("LIBRARY_PATH",     "/util/opt/openmpi/1.10/intel/13/lib")
prepend_path("CPATH",             "/util/opt/openmpi/1.10/intel/13/include")
prepend_path("PKG_CONFIG_PATH",        "/util/opt/openmpi/1.10/intel/13/lib/pkgconfig")
