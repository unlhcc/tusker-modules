...
prepend_path("MODULEPATH",          "/util/opt/modulefiles/MPI/intel/13/openmpi/1.8")

family("mpi")

prepend_path("LIBRARY_PATH",     "/util/opt/openmpi/1.8/intel/13/lib")
prepend_path("CPATH",             "/util/opt/openmpi/1.8/intel/13/include")
prepend_path("PKG_CONFIG_PATH",        "/util/opt/openmpi/1.8/intel/13/lib/pkgconfig")