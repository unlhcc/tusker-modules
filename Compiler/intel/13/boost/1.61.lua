...
setenv("BOOST_DIR",	    "/util/opt/boost/1.61/intel/13")
setenv("BOOST_INCLUDE",     "/util/opt/boost/1.61/intel/13/include")

-- Add boost to the LD_LIBRARY_PATH, LIBRARY_PATH
prepend_path("LD_LIBRARY_PATH",   "/util/opt/boost/1.61/intel/13/lib")
prepend_path("LIBRARY_PATH",      "/util/opt/boost/1.61/intel/13/lib")

prepend_path("CPATH",      "/util/opt/boost/1.61/intel/13/include")
