...
setenv("BOOST_DIR",	    "/util/opt/boost/1.59/gcc/5.4")
setenv("BOOST_INCLUDE",     "/util/opt/boost/1.59/gcc/5.4/include")

-- Add boost to the LD_LIBRARY_PATH, LIBRARY_PATH
prepend_path("LD_LIBRARY_PATH",   "/util/opt/boost/1.59/gcc/5.4/lib")
prepend_path("LIBRARY_PATH",      "/util/opt/boost/1.59/gcc/5.4/lib")
prepend_path("CPATH",      "/util/opt/boost/1.59/gcc/5.4/include")
prepend_path("PATH", "/util/opt/boost/1.59/gcc/5.4/bin")
prepend_path("MANPATH", "/util/opt/boost/1.59/gcc/5.4/share/man")
