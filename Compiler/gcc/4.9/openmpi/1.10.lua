...
local mdir = pathJoin(mroot,"MPI","gcc","4.9","openmpi","1.10")
prepend_path("MODULEPATH",          mdir)

family("mpi")

prepend_path("LIBRARY_PATH",     "/util/opt/openmpi/1.10/gcc/4.9/lib")
prepend_path("CPATH",             "/util/opt/openmpi/1.10/gcc/4.9/include")
prepend_path("PKG_CONFIG_PATH",        "/util/opt/openmpi/1.10/gcc/4.9/lib/pkgconfig")
