...
prepend_path("PATH",              "/util/opt/jags/4.2/gcc/4.9/bin")
prepend_path("LD_LIBRARY_PATH",   "/util/opt/jags/4.2/gcc/4.9/lib")
prepend_path("MANPATH",   "/util/opt/jags/4.2/gcc/4.9/share/man")

prereq("acml/6.1")

prepend_path("LIBRARY_PATH",   "/util/opt/jags/4.2/gcc/4.9/lib")
prepend_path("PKG_CONFIG_PATH",        "/util/opt/jags/4.2/gcc/4.9/lib/pkgconfig")