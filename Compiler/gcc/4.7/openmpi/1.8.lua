...
prepend_path("MODULEPATH",	    "/util/opt/modulefiles/MPI/gcc/4.7/openmpi/1.8")

family("mpi")

prepend_path("LIBRARY_PATH",     "/util/opt/openmpi/1.8/gcc/4.7/lib")
prepend_path("CPATH",             "/util/opt/openmpi/1.8/gcc/4.7/include")
prepend_path("PKG_CONFIG_PATH",        "/util/opt/openmpi/1.8/gcc/4.7/lib/pkgconfig")