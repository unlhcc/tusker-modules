...
prepend_path("PATH",                "/util/opt/openmpi/1.6/gcc/4.7/bin")
prepend_path("LD_LIBRARY_PATH",     "/util/opt/openmpi/1.6/gcc/4.7/lib")
prepend_path("MANPATH",             "/util/opt/openmpi/1.6/gcc/4.7/share/man")
prepend_path("INCLUDE",             "/util/opt/openmpi/1.6/gcc/4.7/include")
prepend_path("MODULEPATH",	    "/util/opt/modulefiles/MPI/gcc/4.7/openmpi/1.6")
