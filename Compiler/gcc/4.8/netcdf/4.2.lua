...
prepend_path{"PATH",                "/util/opt/netcdf/4.2/gcc/4.8/bin",priority=100}
...
prepend_path("LIBRARY_PATH",     "/util/opt/netcdf/4.2/gcc/4.8/lib")
prepend_path("CPATH",             "/util/opt/netcdf/4.2/gcc/4.8/include")
prepend_path("PKG_CONFIG_PATH",        "/util/opt/netcdf/4.2/gcc/4.8/lib/pkgconfig")