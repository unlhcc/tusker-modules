...
prepend_path("MANPATH",             "/util/comp/gcc/6.1/man")
prepend_path("INCLUDE",             "/util/comp/gcc/6.1/include")
prepend_path("MODULEPATH",          "/util/opt/modulefiles/Compiler/gcc/6.1")
...
prepend_path("LIBRARY_PATH",     "/util/comp/gcc/6.1/lib")
prepend_path("LIBRARY_PATH",     "/util/comp/gcc/6.1/lib64")

prepend_path("PKG_CONFIG_PATH",        "/util/comp/gcc/6.1/lib/pkgconfig")
prepend_path("PKG_CONFIG_PATH",        "/util/comp/gcc/6.1/lib64/pkgconfig")
