...
prepend_path("LIBRARY_PATH",     "/util/comp/gcc/8.2/lib")
prepend_path("LIBRARY_PATH",     "/util/comp/gcc/8.2/lib64")

prepend_path("PKG_CONFIG_PATH",        "/util/comp/gcc/8.2/lib/pkgconfig")
prepend_path("PKG_CONFIG_PATH",        "/util/comp/gcc/8.2/lib64/pkgconfig")
