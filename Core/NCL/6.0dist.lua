...
prepend_path("PATH","/util/opt/NCL/6.0dist/bin")
prepend_path("MANPATH","/util/opt/NCL/6.0dist/man")

setenv("NCARG_ROOT","/util/opt/NCL/6.0dist")
setenv("NCARG_INC","/util/opt/NCL/6.0dist/include")
setenv("NCARG_LIB","/util/opt/NCL/6.0dist/lib")
setenv("NCARG_BIN","/util/opt/NCL/6.0dist/bin")
