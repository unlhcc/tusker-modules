...
setenv("TMP",   " /work/HCC/DATA/hugeseq/1.0/data/tmp")
setenv("REF",   " /work/HCC/DATA/hugeseq/1.0/data/hg19/hg19.fa")
setenv("SNP",   " /work/HCC/DATA/hugeseq/1.0/data/dbsnp_132.hg19.vcf")
setenv("BPLIB", " /work/HCC/DATA/hugeseq/1.0/data/bplib/bplib.fa")
