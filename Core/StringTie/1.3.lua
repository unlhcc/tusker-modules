help (
[[
This module loads the StringTie assembler.
Documentation can be found online at https://ccb.jhu.edu/software/stringtie/
Version 1.3.0
...
prepend_path("PATH","/util/opt/BCRF/StringTie/1.3/gcc/4.4/")
