...
setenv("BOOST_DIR",	    "/util/opt/boost/1.61/gcc/4.4")
setenv("BOOST_INCLUDE",     "/util/opt/boost/1.61/gcc/4.4/include")

-- Add boost to the LD_LIBRARY_PATH, LIBRARY_PATH
prepend_path("LD_LIBRARY_PATH",   "/util/opt/boost/1.61/gcc/4.4/lib")
prepend_path("LIBRARY_PATH",      "/util/opt/boost/1.61/gcc/4.4/lib")
prepend_path("CPATH",             "/util/opt/boost/1.61/gcc/4.4/include")
