...
prepend_path("PATH",              "/util/opt/cuda/5.5/bin")
prepend_path("LD_LIBRARY_PATH",   "/util/opt/cuda/5.5/lib64")
prepend_path("LD_LIBRARY_PATH",   "/util/opt/cuda/5.5/lib")
prepend_path("MANPATH",		  "/util/opt/cuda/5.5/doc/man")
setenv("CFLAGS",		  "-I/util/opt/cuda/5.5/include")
setenv("CPPFLAGS",		  "-I/util/opt/cuda/5.5/include")
setenv("FFLAGS",                  "-I/util/opt/cuda/5.5/include")

prepend_path("LIBRARY_PATH",   "/util/opt/cuda/5.5/lib64")
prepend_path("LIBRARY_PATH",   "/util/opt/cuda/5.5/lib")