...
load("python/2.7","ruby/2.1","blast-legacy/2.2.26","blat/35x1","bwa/0.7","muscle/3.8","mummer/3.23","bowtie/1.0.0","scan-for-matches/1.0","velvet/1.2","idba/1.1","prodigal/2.60","usearch/7.0","hmmer/3.1","ray/2.3")
